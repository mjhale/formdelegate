...
import { fetchStripePortalUrl } from '../actions';
...
export default function StripePortalButton() {
  ...
  async function handleManageBilling() {
    ...
    const stripePortalUrl = await fetchStripePortalUrl();
